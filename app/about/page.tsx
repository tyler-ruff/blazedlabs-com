                    ...
                    <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right space-y-10">
                        ...
                        <div className="mt-4 md:mt-8 space-x-3 space-y-3">
                            ...
                            <Link
                                ...
                                className="inline-block rounded bg-error bg-gray-900 dark:bg-white px-12 py-3 text-sm font-medium text-white dark:text-black transition dark:hover:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-300 focus:outline-none focus:ring focus:ring-gray-400 dark:focus:ring-gray-800">
                             Data Security
                            </Link>
                        </div>
                    </div>
