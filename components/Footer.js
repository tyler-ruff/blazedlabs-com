...
export const Footer = ({ settings }) => {
  ...
  return (
        <footer aria-label="Site Footer" className="bg-white border-t">
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div className="lg:flex lg:items-start lg:gap-8">
            <div className="text-teal-600">
            <PrismicLink href="/" className="text-xl font-semibold tracking-tight">
                <img alt="Logo Image" priority="true" className="pt-0 hover:opacity-75" title="Blazed Labs" src="https://blazed.sirv.com/logo/Beaker-Dark.png?w=45&h=45"/>
            </PrismicLink>
            </div>
            ...
            >
                ...
                <div className="col-span-2 sm:col-span-1">
                <p className="font-medium text-gray-900">Divisions</p>
                ...
                <div>
                <ul
                className="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end mt-10"
                >
                <li>
                    <a
