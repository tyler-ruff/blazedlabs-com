export default function Logo(){
    return (
        <i className="block pl-2 pt-1 text-gray-700 dark:text-gray-200">
            <svg fill="currentColor" version="1.0" xmlns="http://www.w3.org/2000/svg"  width="30px" height="30px" viewBox="0 0 300.000000 300.000000"  preserveAspectRatio="xMidYMid meet">  
