...
This Cookie Policy explains how Blazed Labs LLC ("Company," "we," "us," and "our") uses cookies and similar technologies to recognize you when you visit our website at https://blazedlabs.com ("Website"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
...
Cookies set by the website owner (in this case, Blazed Labs LLC) are called "first-party cookies." Cookies set by parties other than the website owner are called "third-party cookies." Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g., advertising, interactive content, and analytics). The parties that set these third-party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites.
...
If you have any questions about our use of cookies or other technologies, please email us at [privacy@blazed.company](mailto:privacy@blazed.company) 

**Or, you may contact us by mail:**
* **Blazed Labs LLC**
    * 1650 Simpson Ave, Ocean City, NJ 08226, USA
    * Ocean City, NJ 08226
    * United States
...
* Fax: [+1 (609) 543-5771](tel:+16095435771)
* Email: [privacy@blazed.company](mailto:privacy@blazed.company)
